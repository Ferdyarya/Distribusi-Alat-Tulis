...
@section('content')
    ...
    <title>Tambah Data Kekurangan</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Kekurangan</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('kekurangan.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <!-- Input angka untuk jumlah -->
                                                    <input type="number" name="qty" id="qty"
                                                        class="form-control @error('qty') is-invalid @enderror"
                                                        placeholder="Masukan Qty" required min="1"
                                                        value="{{ old('qty') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <!-- Input angka -->
                                                    <input type="number" name="qtyditerima" id="qtyditerima"
                                                        class="form-control @error('qtyditerima') is-invalid @enderror"
                                                        placeholder="Masukan Qty" required min="1"
                                                        value="{{ old('qtyditerima') }}">
                                                </div>
                                            </div>
