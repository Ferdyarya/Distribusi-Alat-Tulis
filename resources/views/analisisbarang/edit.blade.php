...
@section('content')
    ...
    <title>Data Analisis Kebutuhan Barang</title>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body" style="border-radius: 15px;">
                    <h1 class="text-center mb-4">Edit Data Analisis Kebutuhan Barang</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('analisisbarang.update', $item->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $item->keterangan }}" type="text"
