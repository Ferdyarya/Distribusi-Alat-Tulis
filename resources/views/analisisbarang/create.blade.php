...
@section('content')
    ...
    <title>Tambah Data Analisis Kebutuhan Barang</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Analisis Kebutuhan Barang</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('analisisbarang.store') }}"
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="id_masterdinaspenerima">Permintaan Ke</label>
                                            ...
                                            <div class="form-group">
                                                <label for="tanggal">Tanggal Analisis</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="keterangan"
                                                    ...
                                                    id="keterangan" value="{{ old('keterangan') }}" required placeholder="Masukan Keterangan">
                                                @error('keterangan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
