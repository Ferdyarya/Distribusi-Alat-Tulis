      ...
      <div class="card-body">
        <div class="content-wrapper">
            ...
            <div class="content-header">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Request barang</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Data Request barang</li>
                            </ol>
                        </div>
                    </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    <div class="col-auto">
                        <form action="requestbarang" method="GET">
                            <input type="text" id="search" name="search" class="form-control" placeholder="Search">
                        </form>
                    </div>
                    {{-- Button Export PDF --}}
                    <div class="col-auto">
                        <a href="{{ route('requestbarang.create')}}" class="btn btn-primary">
                            Tambah Data
                        </a>
                    </div>
                </div>
                <div>
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            $no=1;
                            @endphp
                            @foreach ($requestbarang as $index => $item)
                            <tr>
                                <th class="px-6 py-2">{{ $index + $requestbarang->firstItem() }}</th>
                                ...
                                <td class="px-6 py-2">
                                    <a href="{{ route('requestbarang.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                    <form action="{{ route('requestbarang.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('delete')
