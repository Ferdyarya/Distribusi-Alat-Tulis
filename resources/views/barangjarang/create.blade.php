...
@section('content')
    ...
    <title>Tambah Data Analisis Barang Jarang Diminta</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Analisis Barang Jarang Diminta</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('barangjarang.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="usulan" class="form-control" required>
                                                    ...
                                                    <option value="Usulkan Dihapus">Usulkan Dihapus</option>
                                                    <option value="Tetap Sediakan">Tetap Sediakan</option>
                                                </select>
                                            </div>
