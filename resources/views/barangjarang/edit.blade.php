...
@section('content')
    ...
    <title>Data Analisis Barang Jarang Diminta</title>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body" style="border-radius: 15px;">
                    <h1 class="text-center mb-4">Edit Data Analisis Barang Jarang Diminta</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('barangjarang.update', $item->id) }}"
                                            ...
                                            <div class="form-group">
                                                <label for="tanggal">Terakhir Diminta</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="usulan" class="form-control" required>
                                                    <option value="">-- Pilih Usulan --</option>
                                                    <option value="Usulkan Dihapus"
                                                        {{ $item->usulan == 'Usulkan Dihapus' ? 'selected' : '' }}>Usulkan
                                                        Dihapus</option>
                                                    <option value="Tetap Sediakan"
                                                        {{ $item->usulan == 'Tetap Sediakan' ? 'selected' : '' }}>Tetap
                                                        Sediakan</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="catatan" class="form-control" rows="3" required>{{ $item->catatan }}</textarea>
                                            </div>
