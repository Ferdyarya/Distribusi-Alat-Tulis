                                  ...
                                  <form method="POST" action="{{ route('masterbarang.store') }}" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                              aria-describedby="emailHelp" placeholder="Masukan Nama Barang" value="{{ old('nama') }}" required>
                                          @error('nama')
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="number" name="qty" class="form-control @error('qty') is-invalid @enderror" id="qty"
                                              aria-describedby="emailHelp" placeholder="Masukan Qty" value="{{ old('qty') }}" required>
                                          @error('qty')
                                              <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                      </div>
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="kategori" class="form-control @error('kategori') is-invalid @enderror" id="kategori"
                                              aria-describedby="emailHelp" placeholder="Masukan Kategori" value="{{ old('kategori') }}" required>
                                          @error('deret')
                                              <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                      </div>
