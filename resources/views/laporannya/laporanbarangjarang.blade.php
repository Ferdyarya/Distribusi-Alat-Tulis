            ...
            <div class="card-body">
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Data Laporan Analisis Barang Jarang Diminta</h3>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Data Laporan Analisis Barang Jarang Diminta</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div>
              ...
              <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
                    ...
                    <div class="container">
                        <form action="{{ route('laporanbarangjarang') }}" method="GET" class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2 pt-4">
                                @if (!empty($filter))
                                    <a href="{{ route('laporanbarangjarangpdf', $filter) }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @else
                                    <a href="{{ route('laporanbarangjarangpdf', 'all') }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @endif
                            </div>
                        </form>
                    ...
                    <div>
                        <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              $no=1;
                              @endphp --}}
                                @foreach ($laporanbarangjarang as $index => $item)
                                    <tr>
