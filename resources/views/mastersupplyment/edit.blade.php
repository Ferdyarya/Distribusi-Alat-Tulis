                  ...
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                  <form method="POST" action="{{ route('mastersupplyment.update', $item->id) }}" enctype="multipart/form-data">
                                      @csrf
                                      @method('PUT')
                                      ...
                                      <div class="form-group">
                                        <label for="nama">Kedinasan</label>
                                        <input value="{{ $item->kedinasan }}" type="text" name="kedinasan" class="form-control"
                                            id="exampleInputPassword1" placeholder="Masukan Kedinasan" required>
                                     </div>
